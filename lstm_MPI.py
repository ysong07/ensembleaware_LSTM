...
if __name__ == '__main__':
  ...
  if rank ==0:
    ...
    model = ReadModelProto('models_33/lstm_combo_2layer_ecog_0_deploy.pbtxt')
    ...
    print rank
    board = LockGPU(board=board_id)   
    model = ReadModelProto('models_33/lstm_combo_2layer_ecog_1_deploy.pbtxt')
    cm.CUDAMatrix.init_random(100)
    np.random.seed(100)
    lstm_autoencoder_0 = LSTMCombo(model)
    train_data_0 = ChooseDataHandler(ReadDataProto('datasets_33/ecog.pbtxt'))
    ...
    print rank
    board = LockGPU(board=board_id)
    model = ReadModelProto('models_33/lstm_combo_2layer_ecog_2_deploy.pbtxt')
    cm.CUDAMatrix.init_random(100)
    np.random.seed(100)
    lstm_autoencoder_0 = LSTMCombo(model)
    train_data_0 = ChooseDataHandler(ReadDataProto('datasets_33/ecog.pbtxt'))
    ...
    print rank
    board = LockGPU(board=board_id)
    model = ReadModelProto('models_33/lstm_combo_2layer_ecog_3_deploy.pbtxt')
    cm.CUDAMatrix.init_random(100)
    np.random.seed(100)
    lstm_autoencoder_0 = LSTMCombo(model)
    train_data_0 = ChooseDataHandler(ReadDataProto('datasets_33/ecog.pbtxt'))
  ...
  for ii in xrange(1, 10000000): 
    ...
    print "error_ensemble" +str(rank+4) +": " + str(loss_1)
    ...
    min_loss = np.min([min_loss_0[0],min_loss_1[0]])
    ...
    if ii %20000 ==5:
	if rank == 0:
	    lstm_autoencoder_0.Save('models_33/train_0/ensemble_MPI_%s' % ii)
 	    lstm_autoencoder_1.Save('models_33/train_4/ensemble_MPI_%s' % ii)
	elif rank==1 :
            lstm_autoencoder_0.Save('models_33/train_1/ensemble_MPI_%s' % ii)
	    lstm_autoencoder_1.Save('models_33/train_5/ensemble_MPI_%s' % ii)
        elif rank==2 :
            lstm_autoencoder_0.Save('models_33/train_2/ensemble_MPI_%s' % ii)
            lstm_autoencoder_1.Save('models_33/train_6/ensemble_MPI_%s' % ii)
	elif rank==3 :
	    lstm_autoencoder_0.Save('models_33/train_3/ensemble_MPI_%s' % ii)
	    lstm_autoencoder_1.Save('models_33/train_7/ensemble_MPI_%s' % ii)
    comm.Barrier()  
